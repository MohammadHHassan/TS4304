...
public class ChatSession implements Runnable
{
	...
	public void run()
	{
		try
		{
			...
			System.out.println(client1Name + " (" + client1IP + ")" + " is connected to " + client2Name + " (" + client2IP + ").");
			
			while(true)
			{
				if(sentMsgToClient1 == false)
				{
					toClient2.writeUTF("There is a problem.");
					toClient2.writeBoolean(sentMsgToClient1);
					break;
				}
				if(sentMsgToClient2 == false)
				{
					toClient1.writeUTF("There is a problem.");
